...
func UpdateProducto(w http.ResponseWriter, r *http.Request) {
	...
	respondwithJSON(w, http.StatusCreated, map[string]string{"message": "successfully update"})
}
...
func DeleteProducto(w http.ResponseWriter, r *http.Request) {
	...
	defer query.Close()
	respondwithJSON(w, http.StatusCreated, map[string]string{"message": "successfully delete"})
}

func respondwithJSON(w http.ResponseWriter, code int, payload interface{}) {
	resonse, _ := json.Marshal(payload)
